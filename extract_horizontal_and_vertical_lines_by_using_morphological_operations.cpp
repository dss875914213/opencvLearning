...
int main(int argc, char** argv)
{
    ...
    //Inverse verical image
    bitwise_not(vertical,vertical);
    show_wait_destroy("vertival_bit",vertical);
    ...
    //Step 1
    Mat edges;
    adaptiveThreshold(vertical,edges,255,ADAPTIVE_THRESH_GAUSSIAN_C,THRESH_BINARY,3,-2);
